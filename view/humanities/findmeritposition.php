...
$w_gpa      = $studentNumber['w_gpa'];
$w_gpa = number_format($w_gpa, 2);
    ...
    <table border="1" align="center" width="100%" style="background: white; font-size: 12px">
        ...
        <tr>
            ...
            <td style="text-align: center; background: #56ABEE">লেটার গ্রেড =   
                ...
                elseif ($w_gpa >= 4 && $w_gpa <= 4.99 ){
                    echo "A";
                }
                elseif ($w_gpa >= 3.5 && $w_gpa <= 3.99 ){
                    echo "A-";
                }
                elseif ($w_gpa >= 3.0 && $w_gpa <= 3.49 ){
                    echo "B";
                }
                elseif ($w_gpa >= 2.0 && $w_gpa <= 2.99 ){
                    echo "C";
                }
                elseif ($w_gpa >= 1 && $w_gpa <= 1.99 ){
                    echo "D";
                }
                else {
        ...
        <tr style="background: #56ABEE;">
            ...
            <td style="text-align: center;"><?= $w_gpa; ?></td>
        </tr>
        ...
        <tr style="background: #56ABEE;">
            ...
            <td style="text-align: center"><?php
                ...
                elseif ($w_gpa >= 4.5 && $w_gpa <= 4.99 ){
                    echo "Pass : Excellent Result!";
                }
                elseif ($w_gpa >= 4 && $w_gpa <= 4.49 ){
                    echo "Pass : Good Result! ";
                }
                elseif ($w_gpa >= 3.5 && $w_gpa <= 3.99 ){
                    echo "Pass : Good ";
                }
                elseif ($w_gpa >= 3 && $w_gpa <= 3.49 ){
                    echo "Pass : Need To Improve! ";
                }
                elseif ($w_gpa >= 2 && $w_gpa <= 2.99 ){
