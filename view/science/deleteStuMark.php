...
<div class="col-md-12">
  ...
  <div class="row">
    <div class="content">
        <form action="view/admin/ninetenmarksheet/science/deleteStuMarkAction.php" method="post">

        <!-- <div class="form-inline">
            <div class="form-group col-lg-12">
                 -->
                 <br />
                <h3 style="font-size: 20px; text-align: center; color: green;">শিক্ষার্থীদের মার্কশীট   ডিলিট  ( বিজ্ঞান - নবম থেকে দশম )</h3>
                <br />
                <?php
