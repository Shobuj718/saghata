  ...
  <div class="container" style="width: 100%; background: 374850">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="view/admin/organizationIfo/slideinsert.php" method="post" enctype="multipart/form-data">

                <h3 class="text-center" style="color: #2559ee">স্লাইডার ছবি যুক্ত করুন   </h3>
                <hr />
