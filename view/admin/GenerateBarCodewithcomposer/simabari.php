    ...
    <div class="row">
         ...
         <div class="col-md-6 col-md-offset-3">
            ...
            <table class="tabledesign" border="1">
                <tr>
                    <td colspan="2" rowspan="2" style="background-color:#D7B295;"><img src="http://www.shimabarisrghs.com/assets/front/images/Monogram.JPG" width="70" height="62"  img-rounded ></td>

                    <td colspan="4" style="background-color:yellow;color:#000;"><strong>সীমাবাড়ী এস.আর বালিকা উচ্চ বিদ্যালয়</strong></td>

                </tr>
                <tr>

                    <td colspan="4" style="font-size:14px;background-color:#fff;color:#000;"> চান্দাইকোনা, শেরপুর, বগুড়া ।   </td>
                </tr>
                ...
                <tr>
                   ...
                   <!-- <td colspan="6" align="center"><img src="images/bg.jpg" width="60" height="55" class="img-round">
                    ...
                    <td colspan="6" align="center" style="background-color:#fff;"><img src="http://www.shimabarisrghs.com/view/admin/uploads/<?= $result['student_image']; ?>" width="90" height="90" class="img-round">
                    </td>
