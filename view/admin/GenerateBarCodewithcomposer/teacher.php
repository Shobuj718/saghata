        ...
        <div class="row">
            <div class="col-md-6 offset-md-3" style="background: white; padding: 20px; box-shadow: 10px 10px 5px #888888;">
                <div class="panel-heading">
                    <h1>Generate Teacher ID Card</h1>
                </div>
                <hr>
                <form action="kghsteacher.php" method="post">
                    <input type="text" style="border-radius: 0px;" name="text" class="form-control" autocomplete="off" placeholder="Enter Teacher Mobile Number..." value="">
                    <br>
