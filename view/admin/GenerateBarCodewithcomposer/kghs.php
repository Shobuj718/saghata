    ...
    <div class="row">
         ...
         <div class="col-md-6 col-md-offset-3">
            ...
            <table class="tabledesign" border="1">
                <tr>
                    <td colspan="2" rowspan="2" style="background-color:;"><img src="images/kghs.JPG" width="70" height="80"  img-rounded ></td>

                    <td colspan="4" style="background-color:yellow;color:#000;"><strong>কৈচড় বালিকা উচ্চ বিদ্যালয় </strong><br>www.kghs.edubd.co<br></td>

                </tr>
                <tr>

                    <td colspan="4" style="font-size:14px;background-color:#fff;color:#000;">   কৈচড়, বগুড়া সদর, বগুড়া    </td>
                </tr>
                ...
                <tr>
                   ...
                   <!-- <td colspan="6" align="center"><img src="images/bg.jpg" width="60" height="55" class="img-round">
                    ...
                    <td colspan="6" align="center" style="background-color:#fff;"><img src="http://localhost/impo/Fapore/view/admin/uploads/<?= $result['student_image']; ?>" width="90" height="90" class="img-round">
                    </td>
               ...
               <tr>
                ...
                <tr>
                    ...
                    <td colspan="6" style="font-size:15px;" align="right"><img src="images/atya.JPG" class="img-rounded" width="90" height="20" > <br />প্রধান শিক্ষকের স্বাক্ষর</td>
