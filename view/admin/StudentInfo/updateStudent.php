...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
 ...
 WHERE unique_id = :unique_id;");
    ...
    if ( !empty($_FILES['student_image']['name']) && !empty($_FILES['father_image']['name']) ){
 ...
 WHERE unique_id = :unique_id;");
    ...
    if ( !empty($_FILES['student_image']['name'])  && !empty($_FILES['mother_image']['name']) ){
