...
$studentNumber = $ninetenscience->studentNumberSelectCommerce($class, $term, $year, $department, $student_id);
...
$result = $ninetenscience->selectNineTenMarkCommerce($class, $shift, $branch, $department, $term, $year);
//$ninetenscience->selectstudetn();
$singgpatotal = $ninetenscience->selectSingleGpaTotalCommerce($class, $term, $year, $student_id);
