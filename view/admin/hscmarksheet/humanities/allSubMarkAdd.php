...
<div class="col-md-12">
  ...
  <div class="row">
    <div class="content">
        ...
        <form action="view/admin/ninetenmarksheet/humanities/allSubMarinsert.php" method="post">

        <!-- <div class="form-inline">
            <div class="form-group col-lg-12">
                 -->
                 <br />
                <h3 style="font-size: 20px; text-align: center; color: green;">শিক্ষার্থীদের নম্বর যোগ  ( মানবিক - নবম থেকে দশম )</h3>
                <br />
                <?php
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label for=""> বিষয় : পৌরনীতি ও নাগরিকতা  </label>
                        <select class="form-control" name="physics" required="">
                            <option selected="">পৌরনীতি ও নাগরিকতা</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-3">
