...
$studentNumber = $ninetenscience->studentNumberSelectHumanities($class, $term, $year, $department, $student_id);
...
$result = $ninetenscience->selectNineTenMarkHumanities($class, $shift, $branch, $department, $term, $year);
//$ninetenscience->selectstudetn();
$singgpatotal = $ninetenscience->selectSingleGpaTotalHumanities($class, $term, $year, $student_id);
