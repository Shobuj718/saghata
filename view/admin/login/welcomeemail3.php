...
<html>
  ...
  <body style="background: #f9f9f9; margin: 0px; padding: 20px" bgcolor="f9f9f9">
    <table cellspacing="0" border="0" cellpadding="0" align="center" width="595" bgcolor="white"
    class="main" style="border-collapse: separate; border-spacing: 0; font-family: Helvetica, Arial, sans-serif; letter-spacing: 0; table-layout: fixed">
      <tr>
        <td class="main-td" style="border: 1px solid #dddddd; border-radius: 2px; box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.05); font-family: Helvetica, Arial, sans-serif; font-size: 16px; padding: 40px 60px">
          <table width="100%" class="header" style="border-collapse: separate; border-spacing: 0; table-layout: fixed">
            <tr>
              <td class="logo" style="font-family: Helvetica, Arial, sans-serif; font-size: 16px; padding: 0; text-align: left"
              align="left">
                <img src="https://uploads.intercom-mail-200.com/i/o/9079573/995d3e38c9bd2d0f11961d7d/File1470677008495"
                width="165" height="64" class="featured" style="padding: 15px 0 30px; text-align: left">
              </td>
            </tr>
          </table>
          <table width="100%" class="content" style="border-collapse: separate; border-spacing: 0; table-layout: fixed">
            <tr>
              <td class="content-td" style="color: #525252; font-family: Helvetica, Arial, sans-serif; font-size: 15px; line-height: 22px; padding: 0">
                <p class="intercom-align-left" style="line-height: 1.5; margin: 0 0 17px; text-align: left !important"
                align="left">Hi Janet,</p>
                <p class="intercom-align-left" style="line-height: 1.5; margin: 0 0 17px; text-align: left !important"
                align="left">Welcome to Calm!  Congratulations on taking the first step towards a happier and
                  healthier mind.</p>
                <p class="intercom-align-left" style="line-height: 1.5; margin: 0 0 17px; text-align: left !important"
                align="left">Over the next 7 days, you will learn the life-changing skill of meditation.  All
                  it takes is a few minutes a day to start feeling calmer, less anxious and more
                  focused.  </p>
                <p class="intercom-align-left" style="line-height: 1.5; margin: 0 0 17px; text-align: left !important"
                align="left">Think of meditation as training for your mind.  Just like with physical exercise,
                  the longer you stick with it, the easier it becomes and the more benefits you will
                  see and feel.  And there is no better time to start than now!  </p>
                <table class="intercom-container intercom-align-center"
                align="center" style="border-collapse: collapse; border-spacing: 0; margin: 17px auto; table-layout: fixed; text-align: center !important">
                  <tr>
                    ...
                    align="left" bgcolor="#0071b2" valign="top">
                      <a class="intercom-h2b-button" target="_blank" href="https://www.calm.com/meditate/qK3IeqhiJP?c=welcome&pid=email"
                      style="background: #0071b2; border: none; border-radius: 3px; color: white; display: inline-block; font-size: 14px; font-weight: bold; outline: none !important; text-decoration: none">Open Calm</a>
                    </td>
                  </tr>
                </table>
                <p class="intercom-align-left" style="line-height: 1.5; margin: 0 0 17px; text-align: left !important"
                align="left">   </p>
                <p class="intercom-align-left" style="line-height: 1.5; margin: 0 0 17px; text-align: left !important"
                align="left">Jennifer and the Calm Team</p>
              </td>
            </tr>
          </table>
        </td>
    ...
    <table width="100%" class="footer" align="middle" style="border-collapse: separate; border-spacing: 0; table-layout: fixed">
      <tr>
        <td style="font-family: Helvetica, Arial, sans-serif; font-size: 16px; padding: 0">
          <table cellspacing="0" border="0" cellpadding="0" align="center" width="600" bgcolor="transparent"
          class="main" style="border-collapse: separate; border-spacing: 0; font-family: Helvetica, Arial, sans-serif; letter-spacing: 0; table-layout: fixed">
            <tr>
              <td class="footer-td" style="font-family: Helvetica, Arial, sans-serif; font-size: 16px; padding: 21px 30px 15px; text-align: center"
              align="center">
                <p style="color: #b7b7b7; font-size: 12px; font-weight: 300; margin: 0 0 6px; text-decoration: none">2 Mint Plaza, San Francisco, CA 94103</p>
                <p class="unsub" style="color: #b7b7b7; font-size: 12px; font-weight: 300; margin: 0; text-decoration: none">
                  <a href="https://oq4r3mkf.intercom-mail.com/unsubscribe?app_id=oq4r3mkf&conversation_id=8639109177&user_id=58b7c93ffb4127a69ea44a54"
                  style="border: none; color: #b7b7b7; display: block; font-size: 12px; font-weight: 300; margin: 12px 0 0; outline: none !important; text-decoration: underline">Unsubscribe</a>
                </p>
                <p class="powered-by" style="color: #b7b7b7; font-size: 12px; font-weight: 300; margin: 18px 0 6px; text-decoration: none">Powered by
                  <a href="https://www.intercom.com/" style="border: none; color: #b7b7b7; font-size: 12px; font-weight: bold; outline: none !important; text-decoration: none">Intercom</a>
                </p>
              </td>
            </tr>
          </table>
    ...
    <img src="https://via.intercom-mail-200.com/o?h=7a98934d18ea6d45176040b63c2b8fd03e0becb0-8639109177"
    width="1" height="1" style="display: block;" alt="intercom">
  </body>
