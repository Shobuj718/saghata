...
$result = $sms->set($_POST)->allStudentNumber();

foreach($result as $data){

  $stringData.=$data['last_Orga_phone'].",";
        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs pull-left">
              ...
              <li class="active"><a href="view/admin/sms/allstudentnumber.php">All Student</a></li>
              <li><a href="view/admin/sms/classwisegurdiannumber.php">Class Wise</a></li>
              <!-- <li><a href="view/admin/sms/ninetenstudentnumber.php">Nine-Ten</a></li> -->
