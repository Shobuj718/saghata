...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	$number = $sms->set($_POST)->sectionWiseGurdian();
...
<section class="content">
	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<h3 style="color:green;">Select Class,Section and Shift wise Gurdian Number for generating  text file...</h3>
			<br />
		</div>

 	<div class="col-md-12">
 			
	<!-- <form action="view/admin/sms/sectionWiseGurdianSearch.php" method="post"> -->
