...
$result = $sms->set($_POST)->nineTenStudentNumber();
        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs pull-left">
              ...
              <li class="active"><a href="view/admin/sms/ninetenstudentnumber.php">Nine-Ten</a></li>
  ...
  <form action="" method="post">
    ...
    <div class="col-md-6 col-md-offset-3">
      <div class="form-group">
        ...
        <!-- <input type="hidden" name="class2" value="দশম"> -->
      </div>
    </div>

    <div class="col-md-6 col-md-offset-3">
      <div class="form-group">
        <input type="hidden" name="class" value="নবম">
      </div>
    </div>
