...
<div class="col-md-12">
  ...
  <div class="row">
    <div class="content">
        <form action="view/admin/onetofivemarksheet/showmarksheet.php" method="post">

        <!-- <div class="form-inline">
            <div class="form-group col-lg-12">
                 -->
                 <br />
                <h3 style="font-size: 20px; text-align: center; color: green;">প্লে থেকে ৫ম শ্রেণীর মার্কশীট </h3>
                <br />
                <?php
            ...
            if(isset($_SESSION['onefiveErr'])){
                //echo "<div class='alert alert-danger'>".$_SESSION['error']."</div>";
                //session_unset();
                echo "<div style='font-size:20px'; class='alert alert-danger'>".$_SESSION['onefiveErr']."</div>";
                //session_destroy();
