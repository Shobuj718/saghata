 	...
 	<section class="content"> 
      ...
      <div class="modal-content">
          <div class="modal-header">
                <h4> Student Attendence Taken Using Student ID Card <a class="pull-right" href="view/admin/scanner/smsbalance.php">Check SMS Balance</a></h4>
          ...
          <div class="modal-body">
              <div class="row">
                  <div class="col-xs-12">
                      <div class="well">
                          <form id="theFormID" name="cartCheckout" method="" action="view/admin/scanner/insert-data.php" method="get" novalidate="novalidate">
                              
                              <div class="form-group">
                                  <label for="barcode" class="control-label">Enter Student ID Number/Scan ID Card</label>
