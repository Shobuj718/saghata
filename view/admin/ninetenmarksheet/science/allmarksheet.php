...
<input type="button" class="btn btn-info" style="text-align:center; float: right;"  onclick="printDiv('printableArea')" value="Print marksheet" />
...
$allmark  = $ninetenscience->allmarksheet($class, $term, $year);
// echo "<pre>";
// var_dump($allmark);
// die();
    ...
    <div class="container">
        <div class="row" >
            <div class="col-md-12" style="background: white;">
             ...
             <h3 style="text-align:center;color:green;">ফাঁপোর ইউনিয়ন পল্লীমঙ্গল উচ্চ বিদ্যালয়</h3>
            <p style="text-align:center;">ডাকঘরঃ বগুড়া , উপজেলাঃ বগুড়া সদর, জেলাঃ বগুড়া ।
 ...
 <br>
    ...
    <table border="1" align="center" width="100%" style="background: white; font-size: 12px">
        ...
        <tr>
            ...
            <tr>
                <?php 
                    if($studentNumber['religion'] == 'ইসলাম  ও নৈতিক শিক্ষা'){ 

                         echo '<td align="center">১১১</td>';
                     }
                    else{ 

                         echo '<td align="center">১১২</td>';
        ...
        <tr>
            <?php  } else{  
                $_SESSION['delete'] = "Value Does not match !!!";
                echo "<script>window.location='allmerit.php'</script>";
           } ?>
        </tr>
