<?php
    ...
    $result = $Ninetenscience->nineTenAllMarkCommerce($class, $term, $year, $student_id);
...
<div class="col-md-12">
  ...
  <div class="row">
    <div class="content">
        <form action="view/admin/ninetenmarksheet/commerce/updateMarksheet.php" method="post">
