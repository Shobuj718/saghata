...
<?php 
    ...
    $section = new Section();
    $results = $section->selectClassThreeSection();
...
<section class="content">
	 <!-- START CUSTOM TABS -->
      <h2 class="page-header">Class Three All Section</h2>
        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs pull-left">
              ...
              <li class="active"><a href="view/admin/classinfo/section/three.php">Three</a></li>
