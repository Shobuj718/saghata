...
<?php 
    ...
    $section = new Section();
    $results = $section->selectClassSevenSection();
...
<section class="content">
	 <!-- START CUSTOM TABS -->
      <h2 class="page-header">Class One All Section</h2>
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs pull-left">
             ...
             <li><a href="view/admin/classinfo/section/allsection.php"  >All Section</a></li>
              <li class="active"><a href="view/admin/classinfo/section/one.php" >One</a></li>
