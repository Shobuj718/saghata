...
<!--             <?php echo "<hr/>"; ?>
 -->            
            <h3 style="text-align:center;color:green;">শিক্ষার্থীদের মার্কশীট (৬ষ্ঠ থেকে ৮ম )</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            গ্রুপ / বিভাগঃ <?= $studentData['department'] ?> <br> 
                            শ্রেণীঃ<?= $studentData['class'] ?> <br>
                            শিফটঃ <?= $shift ?> <br>
                            আইডিঃ <?= $studentData['student_id'] ?> <br>
