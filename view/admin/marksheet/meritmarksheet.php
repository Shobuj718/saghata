...
<div class="col-md-12">
  ...
  <div class="row">
    <div class="content">
        ...
        <form action="view/admin/marksheet/marksheet.php" method="post">
        ...
        <!-- <div class="form-inline">
            <div class="form-group col-lg-12">
                 -->
                 <br />
                <h3 style="font-size: 20px; text-align: center; color: green;">শিক্ষার্থীদের মার্কশীট   ( ৬ষ্ঠ থেকে অষ্টম ) </h3>
                <br />
                <?php
            ...
            <div class="row">
                ...
                <div class="col-md-4">                        
                    <div class="form-group">
                        ...
                        <input type="text" name="student_id" pattern="^[0-9]+" class="form-control" placeholder="Enter id..." id="" required="" autofocus>
                    </div>
