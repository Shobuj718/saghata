                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            শিক্ষার্থীর নামঃ <?= $results2['student_name'] ?> <br>  
                            পিতার নামঃ <?= $results2['father_name'] ?> <br>
                            মাতার নামঃ <?= $results2['mother_name'] ?> <br>
                            পরীক্ষার নামঃ <?= $term ?> <br>
                            গ্রুপ / বিভাগঃ <?= $results2['department'] ?> <br> 
                            শ্রেণীঃ<?= $results2['class'] ?> <br>
                            শিফটঃ <?= $shift ?> <br>
                            আইডিঃ <?= $results2['student_id'] ?> <br>
                         </div>
                    </div> 
                    <!-- <div class="col-md-6">
                        <div class="form-group">
